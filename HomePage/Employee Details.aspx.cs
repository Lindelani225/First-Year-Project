...
namespace HomePage
{
    public partial class Employee_Details : System.Web.UI.Page
    {
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("Insert into Employees values('" + txtFname.Text + "','" + txtMidname.Text + "','" + txtLname.Text + "','" + txtID.Text + "','" + txtBirth.Text + "','" + RadGender.SelectedValue + "','" + txtHireD.Text + "','" + txtRole.Text + ")", con);
                con.Open();
                txtID.Focus();
        ...
        //protected void BtnEmpContact_Click(Object sender, EventArgs e)
        //{
        //}
    }
}